		...
		<table style="width: 1100px; height: 900px;">
			<tr>
				...
				<td class="tddd"><span id="list"> <span class="select">
							<select class="select1" name="codecontent"
						...
						</select> <select class="select2" name="codecontent2"
							style="width: 150px; height: 35px;">
								<!-- 1 -->
			...
			<tr>
				...
				<td class="tddd"><select id="selectBox" class="select3" name="bookAgeLimit"
					style="width: 150px; height: 35px;">
						<!-- 1 -->
			...
			<tr>
				...
				<td class="tddd"><input type="file" name="imageFile"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tddd"><span id="list2"> <span class="table2">
							도서명 : <input type="text" name="titleserise" style="height: 25px;">
							출판 날짜 : <input type="date" name="dateserise"
