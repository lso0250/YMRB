			...
			<div class="image-box">
				<div class="holder">
					...
					<div class="photo-cover">
						...
						<a href="bookview.do?bookNum=${alstn2.BOOK_NUM }" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#show"><img
		...
		<c:forEach var="alstn5" items="${getBookList5}" begin="0" end="9"
			...
			<div class="image-box">
				<div class="holder">
					...
					<!-- photo cover -->
					<div class="photo-cover">
							<a data-toggle="modal" data-target="#modal-testNew" role="button" href="bookView.do?bookNum=${alstn5.BOOK_NUM}">
						<a href="bookview.do?bookNum=${alstn5.BOOK_NUM }" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#show">
						<img src="./image/${alstn5.BOOK_IMAGE }" alt=""	style="width: 167px; height: 107px;" /></a>
						</a>	
					</div>
					<!-- end photo cover -->
